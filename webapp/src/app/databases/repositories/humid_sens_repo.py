...
class HumidityCollectionRepository:
    ...
    def __init__(self) -> None:
        ...
        log.info("Connecting HumidityCollectionRepository .. ")
        ...
        log.info("HumidityCollectionRepository CONNECTED ..")

    def write_data_persistdb(self, writable: dict):
